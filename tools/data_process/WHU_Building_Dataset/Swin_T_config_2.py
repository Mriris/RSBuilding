...
test_data_list = '/home/iris/PycharmProjects/RSBuilding/data_list/mua2/test.txt' ########## Check whether it right or not
test_dataloader = dict(
    batch_sampler=dict(type='BatchSampler_Modified'),
    batch_size=4,
    dataset=dict(
        data_list='/home/iris/PycharmProjects/RSBuilding/data_list/mua2/test.txt', ############ Check whether it right or not
        pipeline=[
...
val_dataloader = dict(
    ...
    batch_size=2,
    dataset=dict(
        data_list='/home/iris/PycharmProjects/RSBuilding/data_list/mua2/test.txt', ############ Check it
        pipeline=[
            dict(type='MultiImgLoadImageFromFile_Modified'),
            dict(type='MultiImgMultiAnnLoadAnnotations_Modified'),
            dict(type='MultiImgPackSegInputs_Modified'),
...
wandb = 0
work_dir = '/home/iris/PycharmProjects/RSBuilding/saved_models/mua2' ########## Change to folder where you want to save your checkpoint when training